...
//	- 비교할 변수를 case 값과 비교하여 같은 case를 찾아 해당 case문을 실행
//	- : 같은 값의 case 구문부터 끝까지 실행
//	- break 문으로 종료 시점을 결정 (break가 있는 switch 종료)
...
//		Switch문을 사용하여 선택에 따른 온도 변환
		...
		case 1: // 섭씨 -> 화씨
			...
			System.out.println("섭씨 :" + temperature + "도는 화씨 :" + fahrenheit + "도 입니다");
			break;
		case 2: // 화씨 -> 섭씨
			double celsius = (temperature - 32) * 5 / 9;
			System.out.println("화씨 :" + temperature + "도는 섭씨 :" + celsius + "도 입니다");
			break;
		default:
