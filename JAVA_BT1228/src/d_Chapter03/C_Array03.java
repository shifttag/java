...
//		가위 바위 보 게임
		...
		Scanner sc = new Scanner(System.in);		// 사용자로부터 입력을 받는 Scanner 객체
		// 난수를 생성하는 Random기능
		Random rd = new Random();					// 컴퓨터의 무작위 선택을 위한 (난수를 생성하는) Random 기능

		// 가위 바위 보 배열
		String[] choices = {"가위", "바위", "보"};
		String userChoice, computerChoice;			// 사용자와 컴퓨터의 선택을 지정할 String 변수 각각 선언
...
//				'종료'를 입력했다면 루프를 탈출
			...
			// rd.nextInt() : 0 부터 n-1 가지의 사이에서 무작위 수를 찾아냄
