...
public class F_ArrayList01 {
	...
	public static void main(String[] args) {
		// 자바의 기본 배열 형태
		// : 한 번 생성하면 크기를 변경할 수 없다
		// : 새로운 배열을 생성하고, 원래 배열의 요소를 복사
		int[] numbers = new int[5];

		// ArrayList 클래스
		// : 자바의 라이브러리에서 제공하는 기능
		// : java.utlls.ArrayList을 import해서 사용
		...
		// 6. ArrayList 원하는 위치에 데이터 삽입
		// 배열명.add(인덱스번호, 추가할데이터)
		arrayList.add(1, 4);
		arrayList.add(1, 5);
		...
		// 8. ArrayList 특정 요소 접근
		// 배열명.get(인덱스번호);
		System.out.println("3번째 인덱스의 요소 : " + arrayList.get(3));
	}
